...
2. **Stamp it.** Fill the title heading and frontmatter: `type: meeting`, `date` = the meeting date, attendees if known, `last_updated` = today, `last_updated_by`. Leave the notes/decisions/actions sections as the template's prompts.
