...
`AGENTS.md` is the source of truth for this workspace. If this file ever conflicts with it, `AGENTS.md` wins. When you work inside a folder (`foundations/`, `work/`, `accounts/`, …), also read that folder's `README.md`.
