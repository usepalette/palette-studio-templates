...
`AGENTS.md` is the source of truth for this workspace. If this file ever conflicts with it, `AGENTS.md` wins. When you work inside a space (`accounts/`, `gtm/`, `product/`, …), also read that space's `README.md` and its `AGENTS.md` if it has one.
